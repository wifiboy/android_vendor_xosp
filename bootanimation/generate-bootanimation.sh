...
tar xfp "vendor/xosp/bootanimation/bootanimation.tar" --to-command="convert - -resize '$RESOLUTION' \"png8:$OUT/bootanimation/\$TAR_FILENAME\""

# Create desc.txt
echo "$SIZE" "$SIZE" 30 > "$OUT/bootanimation/desc.txt"
cat "vendor/xosp/bootanimation/desc.txt" >> "$OUT/bootanimation/desc.txt"
